...
matlab -batch "addpath('$CORE_MATLAB_DIR'); core_matlab('$PROJECT_NAME', 'spot_finding', '$POSITION_NAME', 2048, 32, 1, 3, 10, '$PROJECT_ROOT', '01_data', '02_registration', 'log', 'spotfinding_method', 'max3d', 'sqrt_pieces', 4, 'subtile', $SUBTILE_ID, 'voxel_size', [1,1,1], 'end_bases', ['G','A','A','A'], 'barcode_mode', 'duo', 'split_loc', 6, 'intensity_threshold', 0.2)"
